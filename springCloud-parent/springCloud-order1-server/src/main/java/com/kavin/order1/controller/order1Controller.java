package com.kavin.order1.controller;
...
import com.kavin.feign.utils.ApplicationContextUtils;
...
public class order1Controller {
	...
	public DataObject findOrder(@RequestBody DataObject dataObject) throws Exception {
		...
		//此处发生异常，或在还行feignClient 的fallBack接口
	...
	@RequestMapping(value = "/callUI",method=RequestMethod.GET)
	public DataObject callUcenterI() throws JsonProcessingException {
